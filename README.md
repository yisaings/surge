...
### 2. 小白智慧打印 (EPBox) 全功能解锁
针对功夫豆/小白智慧打印 App 的全方位净化与解锁。
* **特性**：强解 SVIP 身份、去除应用内广告、破除使用限制，实现无广告不限量的高效打印体验。
...
1. 打开 Surge App，进入 **模块 (Modules)** 页面。
2. 点击 **安装新模块 (Install New Module)**。
3. 将你需要安装的模块的 GitHub Raw 链接粘贴进去即可。
